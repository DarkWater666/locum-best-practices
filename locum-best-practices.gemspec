...
Gem::Specification.new do |spec|
  ...
  spec.add_development_dependency 'redcarpet', '~> 1.17', '>= 1.17.0'
  spec.add_development_dependency 'yard', '~> 0.7', '>= 0.7.5'

  spec.add_dependency 'capistrano', '~> 3.4', '>= 3.4.0'
  spec.add_dependency 'capistrano-rails', '~> 1.1', '>= 1.1.0'
  spec.add_dependency 'capistrano-rvm', '~> 0.1', '>= 0.1.0'
  spec.add_dependency 'capistrano3-unicorn', '~> 0.2', '>= 0.2.0'
  spec.add_dependency 'capistrano-rails-console', '~> 1.0', '>= 1.0.0'
  spec.add_dependency 'figaro', '~> 1.1', '>= 1.1.1'
  spec.add_dependency 'unicorn', '~> 5.0', '>= 5.0.0'
  spec.add_dependency 'unicorn-worker-killer', '~> 0.4', '>= 0.4.0'
  spec.add_dependency 'airbrussh', '~> 1.0', '>= 1.0.0'

  spec.add_development_dependency 'rubocop', '~> 0.3', '>= 0.3.0'
end
